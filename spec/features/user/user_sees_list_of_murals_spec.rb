...
feature "user sees a list of murals" do
  scenario "sees a list of mural photos and link for new mural" do
    ...
    Mural.create(name: 'Mountain', location: 'Walnut St', user_id: user.id, description: "This is another description", rating: '2', photo_url: 'https://pixabay.com/en/prairie-highway-the-scenery-679016/')
    visit root_path
